...
function Invoke-StageDashboard {
    ...
    if (-not $GitHubOk -or -not (Get-Command gh -ErrorAction SilentlyContinue)) {
        ...
        Write-Warn2 'After fixing the sign-in, re-run this script - it is the only way in; the Dashboard updates itself only once it is installed.'
...
function Invoke-StageFinish {
    ...
    Write-Host ''
    Write-Host '    A normal working session needs no command at all - Polaris briefs every session'
    Write-Host '    at start (phase, open actions, claims, ideas and decisions) with nothing typed.'
    Write-Host ''
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAajLxd08b9SYyP
# ecohyZabsjGVxPrv4piXWcNy1G7xQaCCDQowggZJMIIEMaADAgECAhARy6Iv4IFR
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOhk70bsHs4B
# j6yCfnytlQay4NDTcM9FFVoCN4VFa5wMMA0GCSqGSIb3DQEBAQUABIIBgB5wt1+J
# k5KHb4Rf2a2g38IeXoIwGebbLWFGZxOdFfyqJlHJXHqEca7p6VrQ9y9laPb255rD
# keq/ft1xoAH5QzvUrS+qDDUmch4/5/oZr/pJf05xkQU2Ehn5W5Pp5/fCDV2YQOL3
# POqF657hk85ZzUm35CIK1IzQcMVHNMcwt0e7R5buHtYIyH9PK6hrNo12YuMBQfa4
# B679f8Cat/P25HfuKkUFAjP0cQTlR7HoYl/YFSP4eFhMDB2ZVmP0hZ2S3oWO2umO
# t2d2SrqZMFQ1VkffTYHvZ1yb5a5PY9LYez94DfjsGw9Lp6I1nAbL4c2HWJyIwF/C
# v+6Y0jaqCUkw5DKW+JE99cwNbZslPd8H4eP6ZPPBeCRTLzuV3yx2jfoJp2Nj+/Kx
# Dlzlq5/dHJYiN75isBb8pvrD6RHG8W1EYgw+FnyTil4ix2B1Lfph1CRuGgwzhnno
# NC0ttYT1ef6gR6pELmwVbVN0b5HMwO0GqQvSBC211sA2IdH49+xLDKLZwqGCGBUw
...
# dwIFAQswMTANBglghkgBZQMEAgEFAAQgjhvPgsLGM6ahOL9gms4kLg5Tq/HZo++1
# RwZKD4ROM+cCBwqofHIqMDgYDzIwMjYwOTIyMTY0ODEwWjADAgEBoFSkUjBQMQsw
...
# DQEJBTEPFw0yNjA5MjIxNjQ4MTBaMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIIW+
# kOEK0kONfMkotq9IsJqyCBd87PiwEmxY05EFJcQ8MD8GCSqGSIb3DQEJBDEyBDD9
# BZQIQ0kFBn6RXbzqABjRJ11EseT+XSBcg0+SHaGltLrPfnEKPrUlClMbSTjACX8w
...
# ECjwd8EcNr3+X3QyR3AnLgMwDQYJKoZIhvcNAQEBBQAEggIAdxMEYC2Ybkzvs1/y
# m7aNufdPfDN0V/h4VVZui8uUna7EA7LXrz0LtnUK2Li+AxL1aobihda6P4iCgK32
# j6klmpr5RNoBPeRmglDTX8L0NjRcrj7zHiWTuHhcIdFO7rxOor+7oiadO+rG6IrF
# ztqbREYeLClgJ9o0WKnUJk4hBw+CZ89MEZFR0ouU2PVsbXk5LMNmtDDfxwdYAPfj
# YgENOH8YPG0876d2YquRhjd9nmV5Ad5wmL3Ep3rzB50A0RYtdJOvVAf6ynrMtet7
# k3EFwn8fa3+Ew/SnbY9ZkdK60IxlIY5KSsH7wmASYRoDDNdCaE5UQifVz6TqteFM
# r8K8HlcfC19Bos4sJUjjXGNZsJKe3dszWm7CZpBtDyrcPpN9yBWwQ/12RiM3I9h1
# Dfj4HoEmuY91OqLOOL7H5vlNtUv5mioxkk2T18XlFAnzpmUSbKqa/Vle56KFL5/u
# tLXGfNYpFOAym204TX8K6bRcYejiQOw6x2RJl2kHDF4pM/Ah+dZnFYjs3rnN7Xig
# iTBqFYCbCTVCkkahdmuuKPs2C3glzS6LtMDpo9LPs8hZnB8rBNtMWuDWb58D9uOH
# yVA8jFrH0YkkrVdBkhAsPS9ROiDiPV78G4Z32xqTr9QV1E9dLZCO81GlZrO/4G7C
# wWx/BYtT9UsOi1h+nJ9zrbba2is=
